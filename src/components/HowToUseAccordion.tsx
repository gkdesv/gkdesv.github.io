...
export const HowToUseAccordion = ({ darkMode }: HowToUseAccordionProps) => {
  return (
    <div className={`rounded-2xl border mb-8 overflow-hidden backdrop-blur-xl transition-all duration-300 ${
      darkMode 
      ...
      <Accordion type="single" collapsible className="w-full">
        <AccordionItem value="how-to-use" className="border-none">
          <AccordionTrigger className={`px-6 py-4 font-semibold text-left hover:no-underline transition-colors ${
            darkMode 
          ...
          <AccordionContent className="px-6 pb-6">
            <div className="space-y-4">
              ...
              <div>
                <h3 className={`font-semibold mb-2 ${
                  darkMode ? 'text-slate-200' : 'text-slate-700'
                }`}>Enter the Middle 5 Digits (if needed)</h3>
